  ...
  return (
    <div className="relative h-full">
      ...
      <div className="pointer-events-none fixed inset-0">
        ...
        <div className="absolute right-0 top-0 h-[40vw] w-[40vw] bg-blue-800/10 blur-[100px] rounded-full" />
        <div className="absolute bottom-0 left-0 h-[40vw] w-[30vw] bg-purple-500/10 blur-[100px] rounded-full" />
      </div>
