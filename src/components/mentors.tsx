...
export default function Mentors() {
	return (
		<section id="Mentors" className="scroll-mt-28 container w-full max-w-[1200px] mx-auto pt-20 mb-16 sm:mb-32">
			{/* Section Title */}
			<div className="text-center mb-12 px-4">
				<h2 className="font-bold text-[clamp(28px,5vw,48px)] leading-tight text-white m-0">
					Learn From The{" "}
					<span className="text-yellow-400">Best Mentors</span>
				</h2>
			</div>
			...
			<div className="flex w-full px-2 mx-auto items-center justify-center gap-4 flex-wrap">
				{mentors.map((mentor, index) => (
					<Card
						className="w-[min(45vw, 20rem)] h-32 sm:w-[min(45vw, 30rem)] sm:h-60 bg-gradient-to-br from-[#01010a] to-[#090a13] border border-white/20 shadow-lg rounded-2xl flex-grow"
						key={mentor.name}
					>
