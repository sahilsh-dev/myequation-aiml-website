...
export default function ProgramBreakdown() {
  return (
    <section className="container relative min-h-dvh space-y-16 py-24 md:py-32 w-[90vw] flex flex-col items-center justify-center">
      <div className="absolute -z-10 w-full mx-auto h-[85dvh]">
