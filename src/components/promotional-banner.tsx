...
export default function PromotionalBanner() {
  ...
  const paymentLink = "https://pages.razorpay.com/AIML-Main";
          ...
          <div className="md:hidden space-y-1">
            ...
            <div className="flex items-center justify-between px-2">
              ...
              <a
                ...
                className="bg-blue-800 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded-lg text-sm shadow-lg hover:shadow-blue-400/60 transition-all duration-300 ease-in-out transform hover:scale-105 border-2 border-blue-600 hover:border-blue-400"
              >
                Register Now
              </a>
            </div>
